...
exports.AdminAuthGuard = exports.AdminJwtStrategy = void 0;
...
let AdminJwtStrategy = class AdminJwtStrategy extends (0, passport_1.PassportStrategy)(passport_jwt_1.Strategy, 'admin-jwt') {
    ...
    constructor(config, prisma) {
        super({
            ...
            secretOrKey: config.get('JWT_SECRET') ?? 'insecure-dev-secret',
        });
        this.prisma = prisma;
    }
...
let AdminAuthGuard = class AdminAuthGuard extends (0, passport_2.AuthGuard)('admin-jwt') {
};
