...
const liveness_dto_1 = require("./dto/liveness.dto");
const otp_service_1 = require("../otp/otp.service");
const liveness_service_1 = require("./liveness.service");
let AuthController = class AuthController {
    auth;
    otp;
    liveness;
    constructor(auth, otp, liveness) {
        this.auth = auth;
        this.otp = otp;
...
], AuthController.prototype, "getLivenessChallenge", null);
__decorate([
    (0, common_1.Post)('liveness/verify'),
    (0, common_1.HttpCode)(common_1.HttpStatus.OK),
    (0, common_1.UseGuards)(shared_1.JwtAuthGuard),
    (0, swagger_1.ApiBearerAuth)(),
    ...
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Object, liveness_dto_1.LivenessResultDto]),
    __metadata("design:returntype", void 0)
], AuthController.prototype, "verifyLiveness", null);
__decorate([
...
exports.AuthController = AuthController = __decorate([
    ...
    __metadata("design:paramtypes", [auth_service_1.AuthService,
        ...
        liveness_service_1.LivenessService])
], AuthController);
